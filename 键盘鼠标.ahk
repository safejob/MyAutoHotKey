/*
此脚本用您的键盘来实现鼠标操作, 几乎相当于真正的鼠标 (在一些任务中甚至更方便)
支持多达五个鼠标按钮和鼠标滚轮的转动. 它还具有能自定义移动速度, 加速和 "轴反转" 的特点. 
*/
...
;Divide by 45o because MouseMove only supports whole numbers,
...
SetKeyDelay, -1
SetMouseDelay, -1
; # win     ! alt     ^ control   + shift   &   * 通配符   
Hotkey, CapsLock & u,     ButtonLeftClick
Hotkey, *NumpadIns,   ButtonLeftClickIns
Hotkey, *NumPad5,     ButtonMiddleClick      
Hotkey, *NumpadClear, ButtonMiddleClickClear
Hotkey, CapsLock & o,   ButtonRightClick
Hotkey, *NumPadDel,   ButtonRightClickDel
Hotkey, *NumPadDiv,   ButtonX1Click
Hotkey, *NumPadMult,  ButtonX2Click


Hotkey, CapsLock & y,   ButtonWheelUp
Hotkey, CapsLock & h,   ButtonWheelDown

Hotkey, CapsLock & i,  ButtonUp
Hotkey, CapsLock & k,  ButtonDown
Hotkey, CapsLock & j,  ButtonLeft
Hotkey, CapsLock & l,  ButtonRight
...
;初始速度
Hotkey, CapsLock & ],  ButtonSpeedUp
Hotkey, CapsLock & [,  ButtonSpeedDown
;加速度
...
;滚轮初始速度
Hotkey, CapsLock & =, ButtonWheelSpeedUp
Hotkey, CapsLock & -, ButtonWheelSpeedDown
;滚轮加速度
